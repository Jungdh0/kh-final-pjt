...
const qnaList = [
  {
    q: '1. 소설가인 당신이 쓰고 싶은 이야기는?',
    a: [
      {
        answer: 'A. 갖은 노력 끝에 정상의 자리에 선 뮤지션 이야기',
        type: [0, 1, 2, 5],
      },
      {
        answer: 'B. 웅장한 세계관 속 세상을 구하는 마법사 이야기',
        type: [3, 4, 8, 9, 13],
      },
      {
        answer: 'C. 온갖 비리와 협박을 이겨내고 정의를 구현한 형사 이야기',
        type: [6, 7, 10, 11, 12],
      },
    ],
  },
  {
    q: '2. 꿀 같은 주말! 주말 동안 할 일은?',
    a: [
      {
      ...
      {
        answer: 'B. 이불 밖은 위험해! 침대에서 군것질과 함께 밀린 영화 보기',
        type: [2, 4, 5, 13],
      },
      {
  ...
  },
  {
    ...
    a: [
      {
        answer: 'A. 저번에 비가 왔을 때 연인과 함께 놀러갔던 추억이 떠오른다',
        type: [0, 3, 5, 6],
      },
      {
      ...
      {
        answer: 'C. 토독토독 빗소리를 들으며 바삭바삭 맛있는 부침개를 부쳐 먹어야지!',
        type: [1, 2, 4, 13],
      },
    ],
  },
  ...
  {
    q: '5. 드라마를 보는 당신. 어떤 시청자인가요?',
    a: [
      {
        answer: 'A. 내용의 현실성을 바꾸는 사람',
        type: [0, 2, 3, 4, 5, 13],
      },
      {
        answer: 'B. 어려운 내용의 드라마를 좋아하는 사람',
        type: [1, 6, 7, 8, 9],
      },
      {
        answer: 'C. 드라마는 진부하다. 보지 않는다',
        type: [10, 11, 12],
      },
    ],
  },
  ...
  {
    q: '14. 빈 화단을 가꾸게 된 당신. 먼저 하는 일은?',
    a: [
      {
        answer: 'A. 참고할 만한 예쁜 화단들을 찾아본다',
        type: [0, 2, 5, 13],
      },
      {
        answer: 'B. 금강산도 식후경. 일단 식사부터 해볼까?',
        type: [1, 3, 4, 8, 9],
      },
      {
        answer: 'C. 화단 주변을 정리하고 땅을 고른다',
        type: [6, 7, 10, 11, 12],
      },
    ],
  },
